...
data modify storage tse:temp val.flavor set from entity @s SelectedItem.components.minecraft:lore[0]
function tse:extensions/offhand/lore/set/with_unusual_finish with storage tse:temp val
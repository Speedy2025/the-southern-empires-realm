...
execute store success score @s tse_unusual run data modify storage tse:unusual vals.effect set from entity @s equipment.head.components."minecraft:custom_data"."tse:unusual"

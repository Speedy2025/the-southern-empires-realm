...
#Get Correct Varient
tellraw @a[tag=tse.target] ["",{"text":" \u0020 \u0020 \u0020 \u0020","strikethrough":true,"color":"blue"},{"text":" Skeleton Horse ","color":"green"},{"text":" \u0020 \u0020 \u0020 \u0020","strikethrough":true,"color":"blue"}]
...
scoreboard players operation #temp3 tser.temp *= #se.const.100 se.storage
scoreboard players operation #temp1 tser.temp -= #temp3 tser.temp
execute if score #temp1 tser.temp matches 0 run scoreboard players set #temp2 tser.temp 7
execute if score #temp1 tser.temp matches 0 run scoreboard players set #temp1 tser.temp 5

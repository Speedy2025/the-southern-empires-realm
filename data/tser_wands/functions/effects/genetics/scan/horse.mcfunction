...
data modify storage rx.playerdb:io player.data.tse.scanned.type set value "minecraft:horse"
...
data modify storage rx.playerdb:io player.data.tse_lobby.scanned.type set value "minecraft:horse"
